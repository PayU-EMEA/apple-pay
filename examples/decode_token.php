...
use PayU\Decoding\ApplePayDecodingService;
...
$applePayDecodingService = $container->get(ApplePayDecodingService::class);
...
$appleId = '2D9940EAE07ED944BF277087FB661B36C13FE820109A51D184092A5CB925B844';
...
try {
    $decodedToken = $applePayDecodingService->decode($privateKey, $appleId, json_decode($paymentData, true), $rootCertificatePath, $expirationTime);

    echo 'Decoded token is: <br/><br/>';
